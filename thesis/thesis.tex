	  ...
	  \section{Dinic's Algorithm}
	   ...
	   \section{Push-Relabel Algorithms}
		...
		\Begin(Relabel-To-Front {(s,t)} :){
	      ...
	      \begin{proof}
		We give a rough idea of the proof. For complete details, the reader is encouraged to refer [link to cormen].\\
	...
	\section{Our observations and a baby step towards parallelism}
	  ...
	  will be smaller owing to the upper bound on the average.
	   ...
	   \end{proof}
		...
		open problem until recently Kelner, Orrechia, et al [link to paper], devised a different procedure that obtains a near linear time approximation for this
		...
		\section{Future Directions and Important Open Problems}
		 ...
		 the newer algorithm that followed this [link to kelner paper] is also inherently sequential. Hence, it is currently an open problem to
		 to make these sequence of algorithms parallel. A first step towards this has been [link to STOC] where the authors have managed
