	...
	\subsection{Dual of the Maximum Flow LP}
	 ...
	 \chapter{Spectral Graphs}
	     ...
	     \section{Eigen Values}
	       Throughout this report, we will be dealing with sqaure matrices which are symmetric unless explicitly mentioned otherwise. \\
		...
		\section{Laplacian system of equations}
		  ...
		  \textbf{Theorem}: \\
		    ...
		    \section{Electrical Flows}
		      ...
		      In this section, we will formalise the above notion and provide some useful definitions and theorems. \\
			...
			All eigen values of $\Pi$ are 0 or 1
 		    ...
 		    \textbf{Electrical enery}: Let $r$ be the vector of resistances of every edge(Here it is the all 1's vector). Let $f$ be the 
