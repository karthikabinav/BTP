	  ...
	  \section{Dinic's Algorithm}
	   ...
	   \section{Push-Relabel Algorithms}
	    ...
	    \subsection{Fully Recursive Specification of the Relabel-To-Front Algorithm}
	      ...
	      the run of the algorithm. At any point, the lis is traversed from left to right, looking for an overflowing vertex and a ``discharge''
	      ...
	      The algoritm contains one key procedure known as the ``discharge'' procedure. The procedure performs the action as follows:
	      \begin{itemize}
	       \item 
