...
% 	      \BEGIN \\ %
	...
	\section{Observations and a baby step towards parallelism}
	  ...
	  will be smaller owing to the upper bound on the average.
	   ...
	   \end{proof}
	    ...
	    \begin{proof}
	      ...
	      Plugging this into (1) and take log on both sides to get an upperbound on $cong_{\overline{f}}(e)$. Setting an upperbound of 1 to this 
